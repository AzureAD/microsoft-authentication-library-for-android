...
public class ClientCapabilitiesE2ETest extends AbstractMsalBrokerTest {

    @Test
    public void testAcquireTokenSilentlyWithClientCapabilities() throws Throwable {
        ...
        requestedClaimAdditionalInformation.setValues(new ArrayList<Object>(Arrays.asList("CP1")));
        claimsRequest.requestClaimInAccessToken(CommandParametersAdapter.CLIENT_CAPABILITIES_CLAIM, requestedClaimAdditionalInformation);
