...
@Ignore
public class TestCase833514 extends AcquireTokenNetworkAbstractTest {
    ...
    public void test_833514() throws MsalException, InterruptedException {
        ...
        // query to load a user from the same tenant (the tenant used for WPJ)
        ...
        // acquire token silently via a different app
