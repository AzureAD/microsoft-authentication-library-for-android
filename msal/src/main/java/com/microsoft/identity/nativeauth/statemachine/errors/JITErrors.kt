...
): RegisterStrongAuthChallengeResult, BrowserRequiredError, Error(errorType = errorType, error = error, errorMessage= errorMessage, correlationId = correlationId, errorCodes = errorCodes, exception = exception)
{
...
class RegisterStrongAuthSubmitChallengeError(
    ...
    override val errorCodes: List<Int>? = null,
    override var exception: Exception? = null
): RegisterStrongAuthSubmitChallengeResult, BrowserRequiredError, Error(errorType = errorType, error = error, errorMessage= errorMessage, correlationId = correlationId, errorCodes = errorCodes, exception = exception)
{
