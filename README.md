...
***2020-11-09*** New updates with [MSAL 2.0.3](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v2.0.3)
...
***10/14/2020*** New updates with [MSAL 2.0.2](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v2.0.2)
 - Correct capitalization of client_capabilities claim 'xms_cc' (LLT) #1191
 
***09/23/2020*** New updates with [MSAL 2.0.1](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v2.0.1)
...
***07/29/2020*** New updates with [MSAL 1.6.0](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.6.0)
...
***07/23/2020*** New updates with [MSAL 1.5.5](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.5.5)
 - Picks up fixes in common@2.0.12-hf1
 
***07/02/2020*** New updates with [MSAL 1.5.4](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.5.4)
 - Fix for NPE if sub_error is null.
 - Picks up common@2.0.12
 
***06/23/2020*** New updates with [MSAL 1.5.3](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.5.3)
 - Changes to delete RT on bad_token suberror.
 - Picks up common@2.0.11
 
***06/12/2020*** New updates with [MSAL 1.5.2](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.5.2)
 - Broker Content Provider Changes
 - FOCI support for Local MSAL
 - Robolectric version update
 - Fixed a bug related tenant ID(#1057)
 
***06/12/2020*** New updates with [MSAL 1.5.1](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.5.1)
 - Fix to add the throwIfNetworkNotAvailable API back to common library for ADAL back compat.
 - Picks up common@2.0.8

***04/24/20204*** New updates with [MSAL 1.5.0](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.5.0)
...
***04/17/2020*** New updates with [MSAL 1.4.1](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.4.1)
...
***02/26/2020*** New updates with [MSAL 1.4.0](https://github.com/AzureAD/microsoft-authentication-library-for-android/releases/tag/v1.4.0)
